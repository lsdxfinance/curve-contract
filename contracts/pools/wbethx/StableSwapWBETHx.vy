# @version 0.2.16
"""
@title wBETH/ETHx Metapool
@dev Utilizes 5Pool to allow swaps between wBETH / ETH / stETH / frxETH / rETH (Rocketpool)
"""
...
def _stored_rates() -> uint256[N_COINS]:
    return [
        PRECISION * PRECISION / wBETH(self.coins[0]).exchangeRate(),
